...
/**
 * Constructor for TFCSInputValidationPlots class
 * Initializes the object with input tree, output file directory and vector of layers
 * Sets batch mode and loads Atlas style macros if running in CINT environment
 * Calls base class method to create color vector
 * @param tree pointer to the input TTree
 * @param outputfiledir string representing the output file directory
 * @param vlayer vector of integers representing the layers
...
/**
 * @brief Plots validation of pi+ and pi- distributions in different layers.
 *
 * @param files Vector of input root files containing FCS flat ntuples.
 ...
 *
 * Detailed description of the function that generates plots for TH1 data
 * using the provided variable and label as input parameters
 *
...
/**
 * Plots a histogram of principal component analysis data for a specified variable.
 *
...
/**
 * @brief Plots a TH1 PCA for the specified variable and layer.
 *
 * @param var The variable to plot.
...
/**
 * Plots a 2D histogram from input validation data.
 *
 * @param var variable to plot
 * @param xlabel label for x-axis
 ...
 * @param var        The variable to plot.
 * @param layer     The layer number.
 * @param pca       The PCA value.
 * @param nbinsx    The number of bins in x.
 * @param xmin      The minimum x value.
 * @param xmax      The maximum x value.
 * @param nbinsy    The number of bins in y.
 ...
 *
 * @param cutoff The cutoff value used for calculating the bin edges.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Returns the maximum energy value for a given layer and PCA index.
 *
 * @param layer The layer number.
 * @param pca The PCA index.
...
/**
 * Returns the maximum radius value for the specified layer and PCA option.
 *
 * @param layer The layer number.
 ...
 *
 * @param opt Input option to determine the unit of measurement mm
...
/**
 * Returns the minimum Rmax value from all layers.
 *
 * @param opt optimization option
 * @return minimum Rmax value
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param filename Name of output HTML file.
