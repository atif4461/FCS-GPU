...
/**
 * Initializes hit to cell mapping with or without wiggle.
 *
 * @param mapping Lateral shape parametrization array to be initialized.
 * @param isNewWiggle Flag indicating whether to initialize with new wiggle or not.
 ...
 * @param[in] sampling integer value
 * @param[in] etaRange vector of strings representing eta range
 * @param[in] etaLowEdge vector of floats representing low edge values
 * @param[in] cellDphiHalve vector of floats representing dphi halve values
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Initializes hit-to-cell mapping with wiggle for a given lateral shape parametrization array.
 *
 * @param mapping             Lateral shape parametrization array to be initialized.
 * @param sampling           Sampling method to be used for initialization.
 * @param rangeMin            Minimum value of the range for initialization.
 * @param rangeMax            Maximum value of the range for initialization.
 * @param cellDphiHalve       Vector of cell dphi halves for scaling.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the new center position of a particle based on its parameters.
 * @param fileName Name of the file containing extrapolation data.
 ...
 * @return Pointer to the calculated center position object.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Creates a new histo lateral shape parametrization object from a file.
 *
 * @param fileName Name of the input file containing histogram data.
 * @param pdgId Particle Data Group ID.
 * @param intMom Integer value representing momentum.
 * @param etaMin Minimum pseudorapidity value.
 * @param etaMax Maximum pseudorapidity value.
 * @param Ebin Energy bin number.
 * @param cs Calorimeter sample identifier.
...
/**
 * Creates a new parametrization Ebin chain for calorimeter samples.
 *
 * @param epara              The base parametrization object.
 * @param mapping           Array of lateral shape parametrizations.
 * @param numbersOfHits     Array of number of hits in simulation.
 * @param shapeFileName    File name of the shape file.
 * @param pdgId             Particle data group ID.
 * @param intMom            Integer momentum value.
 * @param etaMin            Minimum eta value.
 * @param etaMax            Maximum eta value.
 *
 * @return A pointer to the newly created TFCSParametrizationEbinChain object.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Creates a new energy chain parametrization base object.
 *
 * @param randEngine The random engine used for simulations.
 * @param mapping The lateral shape parametrization array for mapping.
 * @param numbersOfHits The lateral shape parametrization array for number of hits.
 * @param pdgid The particle data group ID.
 * @param int_Mom_min The minimum momentum value.
 * @param int_Mom_max The maximum momentum value.
 ...
 *
 * @param randEngine Random number engine used for simulations.
 * @param filename Name of the input file containing parametrization data.
 * @param pdgid Particle ID.
 * @param int_Mom Integer value representing momentum.
 * @param etamin Minimum eta value.
 * @param etamax Maximum eta value.
 *
 * @return A pointer to the newly created TFCSEnergyParametrization object or nullptr on failure.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param numbersOfHits lateral shape parametrization array of number of hits
 * @param Eparafilename filename of the energy parametrization file
 * @param shapefilename filename of the shape file
 * @param pdgid particle ID
...
/**
 * Creates a new parametrization object with energy and shape components.
 *
 * @param randEngine random number generator engine
 * @param mapping lateral shape parametrization array
