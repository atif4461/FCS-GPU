...
/**
 * Removes negative values from a histogram by setting them to a small positive value.
 *
...
/**
 * Destructor to free allocated memory for histograms.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
TFCSVertexZPositionStudies::~TFCSVertexZPositionStudies() {
  for ( TH1F* h : m_histos ) {
...
/**
 * Loads files from a specified directory with nominal and shifted filenames.
 *
 * @param dirname        Directory path where files are located
 * @param filename_nominal Name of the nominal file
 * @param filenames_shifted Vector of names of shifted files
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Sets particle information based on the provided filename.
 *
 * This function attempts to extract particle details such as type and energy
 * from the input filename and stores them in member variables.
 *
 * @param filename The filename containing particle information.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * Iterates over all keys in the nominal file, extracts layer and PCA information,
 * and stores unique values in separate containers.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Loads histograms in a specific layer and PCA.
 *
...
/**
 * Loads the mean energy histogram from file.
 *
...
/**
 * Loads the mean energy histogram for the specified PCA and histogram name.
 *
 * @param pca The principal component analysis number.
...
/**
 * Normalizes histograms by scaling them to unity integral value.
 *
 * This method iterates over all stored histograms, scales each one to have an integral of one,
 * clones the scaled histogram and divides it by a nominal histogram to compute ratios.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Finds the binning for vertex Z position studies.
 *
 * This function determines the optimal binning for vertex Z position studies
 * based on the input parameters. It uses the nominal histogram to calculate
 * the quantiles and then adjusts the binning accordingly.
 *
 ...
 * @param quantile Quantile value to use for calculating the binning
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * Rebins nominal histogram and all other histograms in the collection
 * using the same binning scheme and updates the corresponding ratio histograms
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 *
 * @param[in] outputDir Directory where histogram files will be written
 * @param[in] ratioPlots Flag indicating whether to generate ratio plots
 * @param[in] drawErrorBars Flag indicating whether to include error bars in plots
 * @param[in] useLogScale Flag indicating whether to use logarithmic scale for plots
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @param outputDir Directory where the plot will be saved.
 * @param drawErrorBars Flag to draw error bars on the histogram.
 * @param useLogScale Flag to use logarithmic scale on the y-axis.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Prints an ATLAS label at the specified position with additional text.
 *
 * @param size   The size of the label text.
 * @param x      The x-coordinate of the label position in NDC.
 * @param y      The y-coordinate of the label position in NDC.
 * @param text   The additional text to be printed alongside the ATLAS label.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Writes informational text at specified location on plot.
 *
 * @param info Text to be written
