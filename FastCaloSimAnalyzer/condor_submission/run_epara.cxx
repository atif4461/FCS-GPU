 ...
 * @brief Simulates the energy parametrization.
 *
 ...
 * @brief Calculates the PCA bin from the simulation state.
 *
 * @param simulstate Simulation state.
 * @return PCA bin.
 
int TFCSApplyFirstPCA::get_PCAbin_from_simstate(TFCSSimulationState& simulstate)
 * @brief Gets the PCA data from the simulation state.
 *
 * @param simulstate Simulation state.
 * @return Vector of PCA data.
 
std::vector<double> TFCSApplyFirstPCA::get_PCAdata_from_simstate(TFCSSimulationState& simulstate)
 * @brief Creates a validation plot from the trees.
 *
