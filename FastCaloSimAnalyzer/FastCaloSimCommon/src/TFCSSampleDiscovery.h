 ...
 * @brief Provides functionality for discovering and managing samples in the TFCSSystem.
 *
 * This class offers methods for finding DSIDs, retrieving sample information, and generating names for various applications.
