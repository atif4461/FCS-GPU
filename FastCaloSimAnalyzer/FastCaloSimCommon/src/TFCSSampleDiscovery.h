 ...
 * @brief Provides methods for discovering and managing sample data.
 *
 * This class offers functionality for finding DSIDs, retrieving energy and PDG ID,
 * and accessing various file names related to samples and parametrizations.
