...
namespace FCS {
  ...
  struct SampleInfo {
/**
 * Constructor for SampleInfo class 
 * Initializes sample information with default values 
 * @param dsid_ dataset identifier 
 * @param location_ location of the sample 
 * @param label_ label for the sample 
 * @param pdgId_ particle data group identifier 
 * @param energy_ energy of the sample 
 * @param etaMin_ minimum eta value 
 * @param etaMax_ maximum eta value 
 * @param zVertex_ z vertex coordinate 
