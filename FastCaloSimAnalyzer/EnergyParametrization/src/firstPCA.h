...
/**
 * @class firstPCA
 * @brief Performs principal component analysis on data from a TChain.
 *
 * This class provides methods for running PCA, getting relevant layers inputs,
 * calculating cumulative histograms, and applying cuts.
