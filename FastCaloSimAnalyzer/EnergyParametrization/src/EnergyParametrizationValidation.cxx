...
/**
 * Automatically determines zoom limits for a histogram.
 *
 * @param[in] h1 input 1D histogram
 * @param[out] min minimum value of the zoom range
 * @param[out] max maximum value of the zoom range
 * @param[out] rmin minimum value of the reduced zoom range
 * @param[out] rmax maximum value of the reduced zoom range
...
/**
 * Refills a histogram within specified range and rebins it if necessary.
 *
