 ...
 * @brief Applies the first principal component analysis
 *
 * This class is responsible for applying the first principal component analysis
 * to the input data. It provides methods for initializing, setting cumulative energy
 * histograms, getting PCA bin from simulation state, and running over a chain of events.
