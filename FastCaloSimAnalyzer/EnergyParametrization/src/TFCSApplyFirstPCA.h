...
/**
 * @class TFCSApplyFirstPCA
 * @brief Applies the first Principal Component Analysis PCA to the input data
 * @details This class is responsible for applying the first PCA to the input data
 *          It provides methods for initializing setting cumulative energy histograms
 *          getting PCA bin from simulation state getting PCA data from simulation state
 *          running over a chain of files and calculating quantiles
 * @author [Your Name]
