 ...
 * @brief Applies the first Principal Component Analysis PCA to the data
 * @details This class is responsible for applying the first PCA to the input data
 *          It provides methods for initialization setting cumulative energy histograms
 *          getting PCA bin from simulation state and running over a chain of files
 * @author [Your Name]
