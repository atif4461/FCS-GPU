 ...
 *
 * Initializes object with default parameter values and sets output file name and input chain.
 *
 * @param chain      Input chain of data
...
/**
 * Sets the eta cut range for the first PCA calculation.
 * @param cutLow The lower bound of the eta cut range.
 * @param cutHigh The upper bound of the eta cut range.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * @brief Returns a vector of relevant layers based on the input tree and energy cut.
 *
 * @param read_inputTree The input tree reader.
...
/**
 * @brief Retrieves histograms from a tree for specified layers.
 *
 * This function iterates over events in the input tree, applies an eta cut if required,
 * extracts energy values for each layer, and fills corresponding histograms.
 *
 * @param layer_number Vector of layer numbers to consider.
 * @param read_inputTree Pointer to the input tree reader.
 * @return A vector of TH1D pointers representing the filled histograms.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
...
/**
 * Calculates the cumulant value at a given point in a histogram.
 *
 * @param x The x-value at which to calculate the cumulant.
 * @param h The input histogram.
 * @return The calculated cumulant value.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
