...
/**
 * @class TFCSFlatNtupleMaker
 * @brief A class for creating flat n-tuples from simulation data
 *
 * This class is responsible for initializing histograms, looping over events,
 * studying hit merging, and booking flat n-tuples.
