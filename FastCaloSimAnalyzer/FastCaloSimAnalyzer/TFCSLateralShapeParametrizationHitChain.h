 ...
 * @brief Represents a chain of lateral shape parametrization hits
 * @details This class inherits from TFCSLateralShapeParametrization and provides functionality for managing a chain of hits
 * @author Unknown
