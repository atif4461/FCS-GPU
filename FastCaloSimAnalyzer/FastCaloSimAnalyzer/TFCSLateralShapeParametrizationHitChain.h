 ...
 * @brief A class representing a chain of lateral shape parametrization hits
 * @details This class inherits from TFCSLateralShapeParametrization and provides methods for simulating and managing chains of hits
 * @author Unknown
