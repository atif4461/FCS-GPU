 ...
 * @brief Provides methods for input validation plots
 *
 * This class inherits from TFCSAnalyzerBase and provides functionality for creating various types of plots,
