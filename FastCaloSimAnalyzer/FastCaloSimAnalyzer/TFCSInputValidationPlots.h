...
/**
 * @class TFCSInputValidationPlots
 * @brief Provides functionality for input validation plots
 *
 * This class inherits from TFCSAnalyzerBase and provides methods for creating various types of plots,
 * including TH1 and TH2 plots, as well as methods for calculating energy and Rmax values.
