 ...
 * @brief Studies of vertex Z position in high-energy collisions
 *
 * This class provides methods for loading and analyzing histograms related to vertex Z positions.
 * It allows users to load files, initialize layers and principal components,
 * and perform various analyses such as checking PCA bin decomposition and finding binning.
