 ...
 * @brief A class inheriting from TFCSHistoLateralShapeParametrization for FCAL simulation
 * @details Provides functionality for simulating hits in the FCAL detector
 * @author Unknown
 * @version 1
 * @date Unknown
