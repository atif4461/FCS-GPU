...
/**
 * @class TFCSShapeValidation
 * @brief Provides shape validation functionality for TFCSSimulationRuns
 *
 * This class is responsible for loading geometry, looping over events, and managing truth and extrapolation states.
 * It also provides methods for adding validations and setting parameters such as first event and print frequency.
