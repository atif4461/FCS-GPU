 ...
 * @brief Validation of shape in TFCSSimulator
 *
 * This class provides functionality for validating shapes in the TFCSSimulator.
 * It inherits from TFCSAnalyzerBase and provides methods for loading geometry,
 * looping through events, and managing validation runs.
