...
/**
 * Detailed hit structure containing information about a single hit in the calorimeter
...
/**
 * Struct representing a Geant4 hit in the Fast Calorimeter Simulation.
 
struct FCS_g4hit  * Unique identifier for the hit.
 
Long64_t identifier; * Identifier for the cell where the hit occurred.
 
Long64_t cell_identifier; * Sampling fraction for the hit.
 
int sampling; * Energy deposited at the hit location.
 
float hit_energy; * Time of the hit.
 
float hit_time; * Comparison operator to order hits by energy in descending order.
 *
 * @param rhs The right-hand side hit to compare with.
 * @return True if this hit has higher energy than the right-hand side hit.
...
/**
 * @class FCS_matchedcell
 * @brief Represents a matched structure for a single cell in the Fast Calorimeter Simulation.
 * @details This struct contains data members for the cell, g4 hits, and hits, along with methods for clearing, calculating scaling factors, sorting, and trimming data based on timing cuts.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @struct FCS_matchedcellvector
 * @brief A container for matched cells in an event or single layer
 * @details This struct holds a vector of FCS_matchedcell objects and provides methods for accessing and manipulating the data
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
...
/**
 * @class FCS_truth
 * @brief Represents truth information about particle interactions in the detector
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
