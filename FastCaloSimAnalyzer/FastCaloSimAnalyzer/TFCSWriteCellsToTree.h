...
/**
 * @class TFCSWriteCellsToTree
 * @brief A parametrization class that writes cells to a tree
 * @details This class is responsible for initializing a tree and simulating the writing of cells to it
 * @inherit TFCSParametrization
