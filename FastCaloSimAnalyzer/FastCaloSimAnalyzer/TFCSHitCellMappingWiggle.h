 ...
 * @brief A class representing a hit cell mapping with wiggle functionality
 *
 * This class provides methods for initializing and simulating hits in a calorimeter
 * with an accordion structure. It also includes functionality for loading and storing
 * histogram functions on the GPU.
