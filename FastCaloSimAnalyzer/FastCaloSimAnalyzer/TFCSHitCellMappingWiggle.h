 ...
 * @brief A class representing a hit cell mapping with wiggling functionality
 * @details This class provides methods for initializing and simulating hits in a calorimeter
 * @ingroup Calibration
