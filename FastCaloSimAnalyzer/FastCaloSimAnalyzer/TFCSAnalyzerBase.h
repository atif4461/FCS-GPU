...
protected:
  ...
  template <typename T>
/**
 * Sets the branch status of a given chain and sets the address of a variable.
 *
 * @param chain        The input chain.
 * @param branches    A vector of TBranch pointers.
 * @param name         The name of the branch.
 * @param var          The variable to be associated with the branch.
