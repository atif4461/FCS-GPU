...
protected:
  ...
  template <typename T>
/**
 * @brief Sets up a branch in a TChain object and stores it in a vector of TBranch pointers.
 *
 * @param chain The TChain object to set the branch in.
 * @param branches A reference to a vector of TBranch pointers to store the new branch in.
 * @param name The name of the branch to be set.
 * @param var The variable to associate with the branch.
