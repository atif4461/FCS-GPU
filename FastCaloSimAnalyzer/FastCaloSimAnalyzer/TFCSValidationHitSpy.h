...
/**
 * @class TFCSValidationHitSpy
 * @brief A class used for validation of hits in the detector geometry.
 *
 * This class provides functionality for simulating hits, storing hit information,
 * and calculating various histograms related to hit positions and energies.
