...
/**
 * Brief description of TFCSEnergyInterpolation class 
  
 
@class TFCSEnergyInterpolation 
@brief Provides functionality for energy interpolation in the context of simulation states and truth states 
@author  
@version 1 
@ingroup  
