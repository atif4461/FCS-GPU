...
struct KernelTime {
  ...
  KernelTime() = default;
/**
 * Adds four durations to their respective vectors and increments a counter.
 *
 * @param t1 first duration
 * @param t2 second duration
 * @param t3 third duration
 * @param t4 fourth duration
...
/**
 * Prints all kernel timings in microseconds.
 *
 * @brief Displays detailed timing information for simulation kernels.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
  void printAll() const {
...
/**
 * Calculates and formats simulation statistics as a string.
 *
 * This function computes various metrics such as total counts, average launch times,
 * and standard deviations for different simulation types. It then formats these
 * results into a human-readable string for output purposes.
 *
 * @return A formatted string containing simulation statistics.
 * This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.01.
*/ 
