...
/**
 * @brief Class representing GPU function histogram loader.
 *
 * This class provides functionality for loading and managing histograms 
 * on the GPU. It includes methods for setting and retrieving histogram 
 * pointers, as well as loading data from the host to the device.
