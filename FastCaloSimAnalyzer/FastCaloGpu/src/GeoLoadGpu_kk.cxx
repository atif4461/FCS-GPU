 ...
 * allocates device memory for cells and copies cells to the device, creates an array of cell identities,
 * copies sample index array to the GPU, allocates and copies region grids to the GPU,
 * and loads regions data onto the GPU.
 *
