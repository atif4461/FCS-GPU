...
/**
 * @brief Default constructor for GeoLoadGpuImpl class
  
 * @brief Member variable to store sample index buffer on host device
  
BufHostSampleIndex sample_index_buf_host
 * @brief Member variable to store geographic region buffer on host device
  
BufHostGeoRegion regions_buf_host
 * @brief Member variable to store GPU geometry buffer on host device
  
BufHostGeoGpu geogpu_buf_host
 * @brief Member variable to store vector of long long integer buffers on host device
  
std::vector<BufHostLongLong> reg_vec_host
 * @brief Member variable to store calorimeter detector description buffer on accelerator device
  
BufAccCaloDDE cells_buf_acc
 * @brief Member variable to store sample index buffer on accelerator device
  
BufAccSampleIndex sample_index_buf_acc
 * @brief Member variable to store geographic region buffer on accelerator device
  
BufAccGeoRegion regions_buf_acc
 * @brief Member variable to store GPU geometry buffer on accelerator device
  
BufAccGeoGpu geogpu_buf_acc
 * @brief Member variable to store vector of long long integer buffers on accelerator device
  
std::vector<BufAccLongLong> reg_vec_acc* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.2.
*/ 
