...
/**
 * @brief Constructor for LoadGpuFuncHistImpl class
 * Initializes member variables with allocated device buffers
  
 * @var bufBordersX_acc
 * Buffer for storing border values along X axis on acceleration device
 
 * @var bufBordersY_acc
 * Buffer for storing border values along Y axis on acceleration device
 
 * @var bufContents_acc
 * Buffer for storing content values on acceleration device
 
 * @var bufFH2D_acc
 * Buffer for storing 2D histogram data on acceleration device
 
 * @var bufLowEdge_acc
 * Buffer for storing low edge values on acceleration device
 
 * @var bufSzs_acc
 * Buffer for storing unsigned integer values on acceleration device
 
 * @var bufContentsPtr_acc
 * Buffer for storing pointers to content values on acceleration device
 
 * @var bufBordersPtr_acc
 * Buffer for storing pointers to border values on acceleration device
 
 * @var bufFHs_acc
 * Buffer for storing histogram data on acceleration device
 
 * @var bufContents1D_acc
 * Vector of buffers for storing 1D content values on acceleration device
 
 * @var bufBorders1D_acc
 * Vector of buffers for storing 1D border values on acceleration device
