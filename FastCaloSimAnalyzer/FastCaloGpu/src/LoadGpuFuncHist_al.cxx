...
/**
 * Constructor for the Impl class of LoadGpuFuncHist 
   * Member variable bufBordersX_acc is a buffer for x borders on accelerator device
   * Member variable bufBordersY_acc is a buffer for y borders on accelerator device
   * Member variable bufContents_acc is a buffer for contents on accelerator device
   * Member variable bufFH2D_acc is a buffer for 2D functions on accelerator device
   * Member variable bufLowEdge_acc is a buffer for low edge values on accelerator device
   * Member variable bufSzs_acc is a buffer for sizes on accelerator device
   * Member variable bufContentsPtr_acc is a pointer buffer for contents on accelerator device
   * Member variable bufBordersPtr_acc is a pointer buffer for borders on accelerator device
   * Member variable bufFHs_acc is a buffer for functions on accelerator device
   * Member variable bufContents1D_acc is a vector of buffers for 1D contents on accelerator device
   * Member variable bufBorders1D_acc is a vector of buffers for 1D borders on accelerator device
