...
/**
 * @brief Calculates the memory usage of a TFCS calculation.
 * 
 * This function calculates the resident and virtual memory used by a TFCS calculation.
 * It reads a ROOT file, retrieves the SelPDGID object, and measures the memory usage before and after the retrieval.
 * The difference in memory usage is then calculated and printed out.
 * 
 * @param file The name of the ROOT file to read from (default: "TFCSparam_v008.root").
