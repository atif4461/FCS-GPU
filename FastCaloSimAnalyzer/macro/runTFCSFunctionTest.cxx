...
/**
 * @brief Runs a test of the TFCS function
 *
 * This function tests the functionality of the TFCS class by creating histograms,
 * applying different interpolation methods, and verifying the results.
 *
 * @return None
