 ...
 *
 * This function takes an input histogram and returns a new histogram with the same title,
 * but with x-axis range limited to the specified minimum and maximum values.
 *
 * The number of bins in the output histogram is automatically determined based on the input histogram's binning.
 *
 * @param h_in Input histogram to be zoomed.
 * @return A new histogram with the zoomed-in x-axis range.
...
/**
 * Creates a 2D histogram from a given 2D histogram with an applied energy cutoff.
 *
 ...
 * @param isPhiSymmetry Flag to indicate phi symmetry.
 * @param doMeanRz Flag to enable mean Rz calculation.
 * @param useMeanRz Flag to use pre-calculated mean Rz values.
 * @param doZVertexStudies Flag to enable z-vertex studies.
 * @param seed Random seed value.
 * @param nEvents Number of events to process.
 * @param firstEvent First event index.
 * @param debug Debug flag.
 
void runTFCS2DParametrizationHistogram(int dsid, int dsid_zv0, std::string sampleData, std::string topDir, std::string version, float energy_cutoff, std::string topPlotDir, bool do2DParam, bool isPhiSymmetry, bool doMeanRz, bool useMeanRz, bool doZVertexStudies, long seed, int nEvents, int firstEvent, int debug) 
 * @brief Creates a 2D histogram from a given 2D histogram and an energy cutoff.
 *
 * @param hist Input 2D histogram.
 * @param energyCutoff Energy cutoff value.
 * @return Created 2D histogram.
 
TH2F* Create2DHistogram(TH2* hist, float energyCutoff)
 * @brief Creates a polar plot from a given 2D histogram and saves it to a file.
 *
 * @param hist Input 2D histogram.
 * @param plotDir Plot directory path.
 
void CreatePolarPlot(TH2F* hist, std::string plotDir)
 * @brief Zooms a 1D histogram to a specified range.
 *
 * @param hist Input 1D histogram.
 * @return Zoomed 1D histogram.
 
TH1F* zoomHisto(TH1* hist)* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
 ...
 * @brief Retrieves the --dsid option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --dsid option.
 
try{ dsid=args["--dsid"].asLong();}
 * @brief Retrieves the --dsid_zv0 option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --dsid_zv0 option.
 
try{ dsid_zv0=args["--dsid_zv0"].asLong();}
 * @brief Retrieves the --sampleData option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return String value of the --sampleData option.
 
try{ sampleData=args["--sampleData"].asString();}
 * @brief Retrieves the --topDir option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return String value of the --topDir option.
 
try{ topDir=args["--topDir"].asString();}
 * @brief Retrieves the --version option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return String value of the --version option.
 
try{ version=args["--version"].asString();}
 * @brief Retrieves the --energy_cutoff option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Float value of the --energy_cutoff option.
 
try{ energy_cutoff=std::stof(args["--energy_cutoff"].asString());}
 * @brief Retrieves the --topPlotDir option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return String value of the --topPlotDir option.
 
try{ topPlotDir=args["--topPlotDir"].asString();}
 * @brief Retrieves the --do2DParam option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Boolean value of the --do2DParam option.
 
try{ do2DParam=args["--do2DParam"].asLong();}
 * @brief Retrieves the --isPhiSymmetry option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Boolean value of the --isPhiSymmetry option.
 
try{ isPhiSymmetry=args["--isPhiSymmetry"].asLong();}
 * @brief Retrieves the --doMeanRz option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Boolean value of the --doMeanRz option.
 
try{ doMeanRz=args["--doMeanRz"].asLong();}
 * @brief Retrieves the --useMeanRz option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Boolean value of the --useMeanRz option.
 
try{ useMeanRz=args["--useMeanRz"].asLong();}
 * @brief Retrieves the --doZVertexStudies option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Boolean value of the --doZVertexStudies option.
 
try{ doZVertexStudies=args["--doZVertexStudies"].asLong();}
 * @brief Retrieves the --seed option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --seed option.
 
try{ seed=args["--seed"].asLong();}
 * @brief Retrieves the --nEvents option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --nEvents option.
 
try{ nEvents=args["--nEvents"].asLong();}
 * @brief Retrieves the --firstEvent option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --firstEvent option.
 
try{ firstEvent=args["--firstEvent"].asLong();}
 * @brief Retrieves the --debug option value from the parsed arguments.
 *
 * @param args Map of parsed command line arguments.
 * @return Long integer value of the --debug option.
 
try{ debug=args["--debug"].asLong();}
 * @brief Runs the TFCS 2D parametrization histogram function.
 *
 * @param dsid Data set ID.
 * @param dsid_zv0 Data set ID for z-vertex studies.
 * @param sampleData Sample data file path.
 * @param topDir Top directory path.
 * @param version Version string.
 * @param energy_cutoff Energy cutoff value.
 * @param topPlotDir Top plot directory path.
 * @param do2DParam Flag for 2D parametrization.
 * @param isPhiSymmetry Flag for phi symmetry.
 * @param doMeanRz Flag for mean Rz calculation.
 * @param useMeanRz Flag for using mean Rz.
 * @param doZVertexStudies Flag for z-vertex studies.
 * @param seed Random seed value.
 * @param nEvents Number of events.
 * @param firstEvent First event number.
 * @param debug Debug flag.
 
runTFCS2DParametrizationHistogram(dsid,dsid_zv0,sampleData,topDir,version,energy_cutoff,topPlotDir,do2DParam,isPhiSymmetry,doMeanRz,useMeanRz,doZVertexStudies,seed,nEvents,firstEvent,debug);* This comment was generated by meta-llama/Llama-3.3-70B-Instruct:None at temperature 0.5.
*/ 
int main(int argc, char **argv)
{
