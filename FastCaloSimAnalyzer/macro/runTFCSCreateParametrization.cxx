...
/**
 * @brief Runs the TFCS Create Parametrization process.
 *
 * This function initializes the lateral shape parametrization arrays,
 * creates a random engine, and sets up the parametrization chain.
 * It also writes the parametrization to a file and prints memory usage.
 *
